    ...
    ""maps"": [
        {
            ...
            ""id"": ""7c70368e-7917-46ef-8ffd-b8cc39506b3f"",
            ""actions"": [
                {
                    ""name"": ""CameraLook"",
                    ""type"": ""Value"",
                    ""id"": ""4dcd30e4-9d84-4c9f-b450-a1aac7916211"",
                ...
                },
                {
                    ""name"": ""PlayerMove"",
                    ""type"": ""Value"",
                    ""id"": ""ca5c9436-72e9-4737-9f58-f135c0252d2c"",
                    ""expectedControlType"": ""Vector2"",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""09b54897-b3b6-4578-b77e-bb1900762645"",
                    ""path"": ""<Mouse>/delta"",
                    ""interactions"": """",
                    ""processors"": """",
                ...
                {
                    ""name"": ""WASD Keys"",
                    ""id"": ""26f5537d-48ae-470e-bab1-dd759eecf81c"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""afd04534-e495-4615-ada0-28db46885d53"",
                    ""path"": ""<Keyboard>/w"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard and Mouse"",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""3ab956fb-ffcb-4f59-847c-0d664760005c"",
                    ""path"": ""<Keyboard>/s"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard and Mouse"",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""fcd3662a-bb54-457c-baf2-1b774e6d4486"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard and Mouse"",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""47b03950-859f-4e0c-b751-134ccded89dc"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard and Mouse"",
                ...
                {
                    ""name"": ""Arrow Keys"",
                    ""id"": ""379aa185-61ea-4efe-a82a-e4b64b95dbdd"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""122c8738-f0b7-4dbb-8953-6b18d358aa97"",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""df6fe52d-c2d1-4527-997c-f946a2c10ba8"",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""2ad36ece-d046-47a3-9290-edcd205a585a"",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""56ec6728-30ed-4c92-beaf-c242c451c3f3"",
